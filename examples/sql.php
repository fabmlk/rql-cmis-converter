...
$rql = '(not(like(document,tot*))|eq(name,toto)|(name<>3&d>=string:4&eq(name,-3)))&in(u,(2,5,3))u!=5&not(or(u=null(),between(i,1,10)))&z=1&(a==2|b<-3|out(c,(2,float:3)))&select(a,sum(b),max(i))&sort(+a,-b)&limit(1,2)&groupby(type)';
echo $rql . PHP_EOL;
